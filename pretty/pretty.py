...
class style:
    ...
    def palette(self, palette):
        if palette in self.color_options:
            self._palette = palette
        else:
            raise ValueError(f"Palette {palette} is not valid.")




class style_classic(style):
    ...
    def set_rcParams(self):
        ...
        mpl.rcParams['axes.prop_cycle'] = cycler('color', self.color_options[self._palette])
...
class pretty:
    def __init__(self, palette = 'ponyo', style = 'classic'):
